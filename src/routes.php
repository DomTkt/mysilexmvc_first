...
$app->get('/users/dom','App\Users\Controller\IndexController::listNom')->bind('/users/dom');

$app->get('/arret/list', 'App\Users\Controller\IndexController::listAction')->bind('arret.list');
